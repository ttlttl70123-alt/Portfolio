...
const inputDir = 'C:\\Users\\HOME\\Desktop\\portfolio\\images\\03_Product_design1';
const outputDir = 'C:\\Users\\HOME\\Desktop\\Figma_Optimized_Images\\03_Product_design1';
...
processImages(inputDir).then(() => {
  console.log('Done optimizing 03_Product_design1');
}).catch(console.error);
